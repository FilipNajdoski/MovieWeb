    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieTitle = table.Column<string>(maxLength: 60, nullable: false),
                    ...
                    MoviePosterURL = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieRole", x => x.RoleID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonName = table.Column<string>(maxLength: 60, nullable: false),
                    ...
                    IMDBPersonLink = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCasts", x => new { x.MovieID, x.MovieRoleID, x.PersonID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCasts_MovieRole_MovieRoleID",
                        column: x => x.MovieRoleID,
                        principalTable: "MovieRole",
                        principalColumn: "RoleID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCasts_Person_PersonID",
                        column: x => x.PersonID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieCasts_MovieRoleID",
                table: "MovieCasts",
                column: "MovieRoleID");
